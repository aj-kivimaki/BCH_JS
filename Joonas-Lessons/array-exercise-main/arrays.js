...
document.querySelector('#task9').textContent = numbers.sort((a, b) => a - b);

// Task 10
// Randomize the numbers array.

document.querySelector('#task10').textContent = numbers.sort((a, b) => 0.5 - Math.random());
...
document.querySelector('#task11').textContent = `Smallest number is ${numbers[0]} and biggest is ${numbers[numbers.length - 1]}`;